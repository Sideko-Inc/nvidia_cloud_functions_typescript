...
import * as requests from "nvidia_cloud_functions_ts/resources/pexec/functions/versions/request-types";
import { Schemas$PexecFunctionsVersionsCreateResponseArrItem } from "nvidia_cloud_functions_ts/types/pexec-functions-versions-create-response-arr-item";
import { Schemas$PexecFunctionsVersionsCreateResponseObj } from "nvidia_cloud_functions_ts/types/pexec-functions-versions-create-response-obj";
...
export class VersionsClient extends CoreResourceClient {
  ...
  create(
    ...
    | types.PexecFunctionsVersionsCreateResponseObj
    | types.PexecFunctionsVersionsCreateResponseArrItem[]
  > {
    return this._client.makeRequest({
      ...
      responseSchema: z.union([
        Schemas$PexecFunctionsVersionsCreateResponseObj.in,
        z.array(Schemas$PexecFunctionsVersionsCreateResponseArrItem.in),
      ]),
      opts,
    });
  }

...
import * as requests from "nvidia_cloud_functions_ts/resources/nvcf/pexec/functions/request-types";
import { VersionsClient } from "nvidia_cloud_functions_ts/resources/nvcf/pexec/functions/versions";
import { Schemas$NvcfPexecFunctionsCreateResponseArrItem } from "nvidia_cloud_functions_ts/types/nvcf-pexec-functions-create-response-arr-item";
import { Schemas$NvcfPexecFunctionsCreateResponseObj } from "nvidia_cloud_functions_ts/types/nvcf-pexec-functions-create-response-obj";
...
export class FunctionsClient extends CoreResourceClient {
  ...
  create(
    ...
    | types.NvcfPexecFunctionsCreateResponseObj
    | types.NvcfPexecFunctionsCreateResponseArrItem[]
  > {
    return this._client.makeRequest({
      ...
      responseSchema: z.union([
        Schemas$NvcfPexecFunctionsCreateResponseObj.in,
        z.array(Schemas$NvcfPexecFunctionsCreateResponseArrItem.in),
      ]),
      opts,
    });
  }

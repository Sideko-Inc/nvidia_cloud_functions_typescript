...
import * as requests from "nvidia_cloud_functions_ts/resources/nvcf/authorizations/functions/remove/request-types";
...
export class RemoveClient extends CoreResourceClient {
  ...
  patch(
    ...
    return this._client.makeRequest({
      method: "patch",
      path: `/v2/nvcf/authorizations/functions/${request.functionId}/remove`,

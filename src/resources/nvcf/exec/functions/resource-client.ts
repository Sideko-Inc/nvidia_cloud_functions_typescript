...
import * as requests from "nvidia_cloud_functions_ts/resources/nvcf/exec/functions/request-types";
import { VersionsClient } from "nvidia_cloud_functions_ts/resources/nvcf/exec/functions/versions";
...
export class FunctionsClient extends CoreResourceClient {
  ...
  create(
    ...
    return this._client.makeRequest({
      method: "post",
      path: `/v2/nvcf/exec/functions/${request.functionId}`,

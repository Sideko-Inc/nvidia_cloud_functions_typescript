...
import { FunctionsClient } from "nvidia_cloud_functions_ts/resources/exec/functions";
import { StatusClient } from "nvidia_cloud_functions_ts/resources/exec/status";

...
describe("tests client.nvcf.deployments.functions.versions.delete", () => {
  test.concurrent(
...
describe("tests client.nvcf.deployments.functions.versions.get", () => {
  test.concurrent(
    ...
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.nvcf.deployments.functions.versions
          ...
          .asResponse(),
        client.nvcf.deployments.functions.versions.get({
          functionId: "3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
          functionVersionId: "3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        }),
      ]);
...
describe("tests client.nvcf.deployments.functions.versions.create", () => {
  test.concurrent(
    ...
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.nvcf.deployments.functions.versions
          ...
          .asResponse(),
        client.nvcf.deployments.functions.versions.create({
          deploymentSpecifications: [
            {
              backend: "string",
              gpu: "string",
...
describe("tests client.nvcf.deployments.functions.versions.update", () => {
  test.concurrent(
    ...
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.nvcf.deployments.functions.versions
          ...
          .asResponse(),
        client.nvcf.deployments.functions.versions.update({
          deploymentSpecifications: [
            {
              backend: "string",
              gpu: "string",

...
describe("tests client.functions.versions.delete", () => {
  test.concurrent(
...
describe("tests client.functions.versions.list", () => {
  test.concurrent(
...
describe("tests client.functions.versions.get", () => {
  test.concurrent(
...
describe("tests client.functions.versions.create", () => {
  test.concurrent(
    ...
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.functions.versions
          ...
          .asResponse(),
        client.functions.versions.create({
          inferenceUrl: "http://www.example.com",
          name: "string",
          functionId: "3e4666bf-d5e5-4aa7-b8ce-cefe41c7568a",
        }),

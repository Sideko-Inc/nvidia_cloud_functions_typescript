...
describe("tests client.authorizations.functions.versions.delete", () => {
  test.concurrent(
    ...
    async () => {
      ...
      const [rawResponse, response] = await Promise.all([
        client.authorizations.functions.versions
          .delete({
...
describe("tests client.authorizations.functions.versions.get", () => {
  test.concurrent(
...
describe("tests client.authorizations.functions.versions.create", () => {
  test.concurrent(
